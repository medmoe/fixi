...
const CustomerJobsTab: React.FC = () => (
    <div className="rounded-xl border bg-card p-8 text-center">
        <Search className="mx-auto h-10 w-10 text-muted-foreground mb-3"/>
        <h3 className="font-medium text-lg">My Jobs</h3>
        <p className="text-sm text-muted-foreground mt-1">
            Coming soon — view your job history and active requests.
        </p>
    </div>
)
        ...
        <div className="min-h-screen bg-background flex">
            ...
            <div className="flex-1 flex flex-col">
                ...
                <main className="flex-1 container mx-auto px-4 py-8 max-w-5xl">
                    ...
                    {activeTab === 'jobs' && <CustomerJobsTab/>}
                </main>
            </div>
        </div>
    )
