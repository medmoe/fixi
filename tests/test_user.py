...
class TestWriteUser:
    ...
    @pytest.mark.asyncio
    async def test_create_user_success(self, async_session, sample_user_data, sample_user_read):
        ...
        with patch("src.app.api.v1.users.crud_users") as mock_crud:
            ...
            with patch("src.app.api.v1.users.get_password_hash") as mock_hash:
                ...
                result = await write_user(Mock(), user_create, async_session)

                assert result == sample_user_read
                mock_crud.exists.assert_any_call(db=async_session, email=user_create.email)
                mock_crud.exists.assert_any_call(db=async_session, username=user_create.username)
                mock_crud.create.assert_called_once()

    @pytest.mark.asyncio
    async def test_create_user_duplicate_email(self, async_session, sample_user_data):
        ...
        with patch("src.app.api.v1.users.crud_users") as mock_crud:
            ...
            with pytest.raises(DuplicateValueException, match="Email is already registered"):
                await write_user(Mock(), user_create, async_session)

    @pytest.mark.asyncio
    async def test_create_user_duplicate_username(self, async_session, sample_user_data):
...
class TestReadUser:
    ...
    @pytest.mark.asyncio
    async def test_read_user_success(self, async_session, sample_user_read):
        ...
        with patch("src.app.api.v1.users.crud_users") as mock_crud:
            ...
            result = await read_user(Mock(), username, async_session)

            assert result == sample_user_read
            mock_crud.get.assert_called_once_with(
                db=async_session, username=username, is_deleted=False, schema_to_select=UserRead
            )

    @pytest.mark.asyncio
    async def test_read_user_not_found(self, async_session):
        ...
        with patch("src.app.api.v1.users.crud_users") as mock_crud:
            ...
            with pytest.raises(NotFoundException, match="User not found"):
                await read_user(Mock(), username, async_session)
...
class TestReadUsers:
    ...
    @pytest.mark.asyncio
    async def test_read_users_success(self, async_session):
        ...
        with patch("src.app.api.v1.users.crud_users") as mock_crud:
            ...
            with patch("src.app.api.v1.users.paginated_response") as mock_paginated:
                ...
                result = await read_users(Mock(), async_session, page=1, items_per_page=10)
...
class TestPatchUser:
    ...
    @pytest.mark.asyncio
    async def test_patch_user_success(self, async_session, current_user_dict, sample_user_read):
        ...
        with patch("src.app.api.v1.users.crud_users") as mock_crud:
            ...
            result = await patch_user(Mock(), user_update, username, current_user_dict, async_session)

            assert result == {"message": "User updated"}
            mock_crud.update.assert_called_once()

    @pytest.mark.asyncio
    async def test_patch_user_forbidden(self, async_session, current_user_dict, sample_user_read):
        ...
        with patch("src.app.api.v1.users.crud_users") as mock_crud:
            ...
            with pytest.raises(ForbiddenException):
                await patch_user(Mock(), user_update, username, current_user_dict, async_session)
...
class TestEraseUser:
    ...
    @pytest.mark.asyncio
    async def test_erase_user_success(self, async_session, current_user_dict, sample_user_read):
        ...
        with patch("src.app.api.v1.users.crud_users") as mock_crud:
            ...
            with patch("src.app.api.v1.users.blacklist_token", new_callable=AsyncMock) as mock_blacklist:
                result = await erase_user(Mock(), username, current_user_dict, async_session, token)

                assert result == {"message": "User deleted"}
                mock_crud.delete.assert_called_once_with(db=async_session, username=username)
                mock_blacklist.assert_called_once_with(token=token, db=async_session)

    @pytest.mark.asyncio
    async def test_erase_user_not_found(self, async_session, current_user_dict):
        ...
        with patch("src.app.api.v1.users.crud_users") as mock_crud:
            ...
            with pytest.raises(NotFoundException, match="User not found"):
                await erase_user(Mock(), username, current_user_dict, async_session, token)

    @pytest.mark.asyncio
    async def test_erase_user_forbidden(self, async_session, current_user_dict, sample_user_read):
