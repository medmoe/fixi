"""added index to uuid field. updated worker_id column name in worker_trade table. updated constraint on bio field to 1000 instead of 500

Revision ID: d3b2f5a1b5d0
Revises: f3fe6900a2c7
Create Date: 2026-07-02 13:02:54.000372+00:00
...
revision: str = 'd3b2f5a1b5d0'
down_revision: Union[str, None] = 'f3fe6900a2c7'
...
def upgrade() -> None:
    ...
    op.create_table('worker_trades',
        ...
        sa.ForeignKeyConstraint(['trade_id'], ['trade_categories.id'], name=op.f('worker_trades_trade_id_fkey'), ondelete='CASCADE'),
        ...
        sa.UniqueConstraint('worker_profile_id', 'trade_id', name=op.f('unique_worker_trade'))
    )
    op.create_index(op.f('ix_worker_trades_worker_profile_id'), 'worker_trades', ['worker_profile_id'], unique=False)
    op.create_index(op.f('ix_worker_trades_trade_id'), 'worker_trades', ['trade_id'], unique=False)
