...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint("tier_name_key", 'tier', type_='unique')
    op.drop_constraint("rate_limit_name_key", 'rate_limit', type_='unique')
    op.drop_constraint("post_id_key", 'post', type_='unique')
