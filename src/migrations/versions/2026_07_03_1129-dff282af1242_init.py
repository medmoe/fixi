...
Revision ID: dff282af1242
Revises: 
Create Date: 2026-07-03 11:29:26.691135+00:00
...
from app.core.db.types import PostGISPoint

# revision identifiers, used by Alembic.
revision: str = 'dff282af1242'
...
def upgrade() -> None:
    ...
    # op.alter_column('worker_trades', 'worker_id', new_column_name="worker_profile_id")
    # op.create_index(op.f('ix_user_uuid'), 'user', ['uuid'], unique=True)
    # op.alter_column('worker_profiles', 'bio', existing_type=sa.String(length=500), type_=sa.String(length=1000))
    # APP tables
    op.create_table('user',
        ...
        sa.Column('location', PostGISPoint(), autoincrement=False, nullable=True),
        ...
        sa.Column('role_type', postgresql.ENUM('CUSTOMER', 'WORKER', name='userrole'), autoincrement=False, nullable=False),
    ...
    op.create_table('trade_categories',
        sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('trade_categories_id_seq'::regclass)"), autoincrement=True, nullable=False),
        ...
        sa.Column('icon_name', sa.VARCHAR(length=120), autoincrement=False, nullable=True),
        sa.Column('parent_id', sa.INTEGER(), autoincrement=False, nullable=True),
        sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=False),
        sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=False),
        sa.ForeignKeyConstraint(['parent_id'], ['trade_categories.id'], name='trade_categories_parent_id_fkey'),
        sa.PrimaryKeyConstraint('id', name='trade_categories_pkey'),
        postgresql_ignore_search_path=False
    )
    op.create_index(op.f('ix_trade_categories_name'), 'trade_categories', ['name'], unique=True)
    op.create_table('worker_profiles',
        ...
        sa.Column('service_radius_km', sa.INTEGER(), autoincrement=False, nullable=True),
        ...
        sa.Column('available_since', sa.DateTime(timezone=True), nullable=True, default=None),
        sa.ForeignKeyConstraint(['user_id'], ['user.id'], name=op.f('worker_profiles_user_id_fkey'), ondelete='CASCADE'),
    ...
    op.create_table('worker_trades',
        sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
        sa.Column('worker_profile_id', sa.INTEGER(), autoincrement=False, nullable=False),
        sa.Column('trade_category_id', sa.INTEGER(), autoincrement=False, nullable=False),
        sa.Column('skill_level', postgresql.ENUM('junior', 'mid', 'senior', name='skilllevel'), autoincrement=False, nullable=False),
        sa.ForeignKeyConstraint(['trade_category_id'], ['trade_categories.id'], name=op.f('worker_trades_trade_category_id_fkey'), ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['worker_profile_id'], ['worker_profiles.id'], name=op.f('worker_trades_worker_profile_id_fkey'), ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id', name=op.f('worker_trades_pkey')),
        sa.UniqueConstraint('worker_profile_id', 'trade_category_id', name=op.f('unique_worker_trade'))
    )
    op.create_index(op.f('ix_worker_trades_worker_profile_id'), 'worker_trades', ['worker_profile_id'], unique=False)
    op.create_index(op.f('ix_worker_trades_trade_category_id'), 'worker_trades', ['trade_category_id'], unique=False)
    ...
    # =============================================================================================================================================
    # Third party tables used by POSTGIS
    # =============================================================================================================================================
    ...
    op.create_table('tract',
        ...
        sa.Column('the_geom', PostGISPoint(), autoincrement=False, nullable=True),
