...
def downgrade() -> None:
    ...
    op.create_table('tier',
                    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('tier_id_seq'::regclass)"),
                              autoincrement=True, nullable=False),
                    sa.Column('name', sa.VARCHAR(), autoincrement=False, nullable=False),
                    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=False),
                    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=True),
                    sa.PrimaryKeyConstraint('id', name='tier_pkey'),
                    sa.UniqueConstraint('name', name='tier_name_key', postgresql_include=[],
                                        postgresql_nulls_not_distinct=False),
                    postgresql_ignore_search_path=False
                    )
    ...
    op.create_table('job',
                    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('job_id_seq'::regclass)"),
                              autoincrement=True, nullable=False),
                    ...
                    sa.Column('status', postgresql.ENUM('OPEN', 'ASSIGNED', 'IN_PROGRESS', 'COMPLETED', 'CANCELLED',
                                                        name='job_status_type'),
                              server_default=sa.text("'OPEN'::job_status_type"), autoincrement=False, nullable=False),
                    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=False),
                    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=True),
                    sa.ForeignKeyConstraint(['customer_id'], ['user.id'], name='job_customer_id_fkey',
                                            ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['service_category_id'], ['service_category.id'],
                                            name='job_service_category_id_fkey'),
    ...
    op.create_table('service_category',
                    sa.Column('id', sa.INTEGER(),
                              server_default=sa.text("nextval('service_category_id_seq'::regclass)"),
                              autoincrement=True, nullable=False),
    ...
    op.create_table('review',
                    ...
                    sa.ForeignKeyConstraint(['job_id'], ['job.id'], name=op.f('review_job_id_fkey'),
                                            ondelete='CASCADE'),
    ...
    op.create_table('handyman_profile',
                    ...
                    sa.Column('certification_urls', postgresql.JSON(astext_type=sa.Text()), autoincrement=False,
                              nullable=False),
                    sa.Column('availability', postgresql.JSON(astext_type=sa.Text()), autoincrement=False,
                              nullable=False),
                    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name=op.f('handyman_profile_user_id_fkey'),
                                            ondelete='CASCADE'),
    ...
    op.create_table('post',
                    ...
                    sa.ForeignKeyConstraint(['created_by_user_id'], ['user.id'],
                                            name=op.f('post_created_by_user_id_fkey')),
                    sa.PrimaryKeyConstraint('id', name=op.f('post_pkey')),
                    sa.UniqueConstraint('uuid', name=op.f('post_uuid_key'), postgresql_include=[],
                                        postgresql_nulls_not_distinct=False)
                    )
    ...
    op.create_table('worker',
                    ...
                    sa.Column('service_category_id', sa.INTEGER(), autoincrement=False, nullable=True),
                    sa.Column('skills', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=False),
                    sa.Column('portfolio_image_urls', postgresql.JSON(astext_type=sa.Text()), autoincrement=False,
                              nullable=False),
                    ...
                    sa.ForeignKeyConstraint(['service_category_id'], ['service_category.id'],
                                            name=op.f('worker_service_category_id_fkey')),
                    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name=op.f('worker_user_id_fkey'),
                                            ondelete='CASCADE'),
    ...
    op.create_table('user',
                    ...
                    sa.Column('role_type', postgresql.ENUM('CUSTOMER', 'HANDYMAN', name='user_role_type'),
                              server_default=sa.text("'CUSTOMER'::user_role_type"), autoincrement=False,
                              nullable=False),
                    sa.Column('token_version', sa.INTEGER(), server_default=sa.text('1'), autoincrement=False,
                              nullable=False),
                    ...
                    sa.UniqueConstraint('uuid', name='user_uuid_key', postgresql_include=[],
                                        postgresql_nulls_not_distinct=False),
                    postgresql_ignore_search_path=False
                    )
    ...
    op.create_table('rate_limit',
                    ...
                    sa.UniqueConstraint('name', name=op.f('rate_limit_name_key'), postgresql_include=[],
                                        postgresql_nulls_not_distinct=False)
                    )
    ...
    op.create_table('files',
                    ...
                    sa.ForeignKeyConstraint(['belongs_to_user_id'], ['user.id'],
                                            name=op.f('files_belongs_to_user_id_fkey')),
    ...
    op.create_table('customer_profile',
                    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
                    sa.Column('user_id', sa.INTEGER(), autoincrement=False, nullable=False),
                    sa.Column('saved_addresses', postgresql.JSON(astext_type=sa.Text()), autoincrement=False,
                              nullable=False),
                    sa.Column('loyalty_points', sa.INTEGER(), server_default=sa.text('0'), autoincrement=False,
                              nullable=False),
                    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name=op.f('customer_profile_user_id_fkey'),
                                            ondelete='CASCADE'),
