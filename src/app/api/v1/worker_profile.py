...
# from ...crud.crud_worker_profile import crud_workers
...
#
#
# @router.post("/worker", response_model=WorkerProfile, status_code=201)
# async def create_worker_profile(
#         request: Request,
#         worker: WorkerProfileCreate,
...
#
#     from ...models.worker_profile import Worker
#
