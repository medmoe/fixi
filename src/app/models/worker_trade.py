...
class WorkerTrade(Base):
    ...
    worker_profile: Mapped["WorkerProfile"] = relationship("WorkerProfile", back_populates="worker_trades", lazy="noload", init=False)
    trade_category: Mapped["TradeCategory"] = relationship("TradeCategory", lazy="noload", init=False)
